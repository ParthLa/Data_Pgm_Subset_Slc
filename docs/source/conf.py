...
master_doc = 'index'
autodoc_mock_imports = ["torch", "sklearn", "utils", "utils_jl", "models", "my_checkpoints", "my_data_feeder_utils", "my_data_types",  "my_gen_cross_entropy_utils", "my_pr_utils", "my_test", "my_train", "my_utils"]
# -- Project information -----------------------------------------------------
